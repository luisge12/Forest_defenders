...
class Level3(BaseState):
    def enter(self) -> None:
        
        self.zoom_level = 1
        self.map = load_map("assets/graphics/tile_maps/Level3.tmx")
        settings.SOUNDS["level_3"].play(loops=-1)
